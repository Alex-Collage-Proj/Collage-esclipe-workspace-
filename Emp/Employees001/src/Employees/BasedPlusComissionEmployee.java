...
public class BasedPlusComissionEmployee extends CommissionEmployee {
	...
	public BasedPlusComissionEmployee(double baseSalary,double grossSales,double commissionRate,String firstName, String lastName, String socialSecurityNumber)
	{
