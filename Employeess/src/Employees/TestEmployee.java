...
public class TestEmployee {
	...
	public static void main(String[] args) {
		...
		try {
			SalariedEmployee SEnormal = new SalariedEmployee(new Contact("070-2111567","mister@gmail.com"),749,"Rash","bash","207655944");
			SalariedEmployee SEcopy = (SalariedEmployee)SEnormal.clone();
			
			System.out.println("Before : \n\n" + SEnormal.ToString() +"\n"+"\n"+SEcopy.ToString());
			
			SEcopy.contact.setEmail("ChangedEmail@gmail.com");
			SEcopy.contact.setPhoneNumber("080-2445678");
